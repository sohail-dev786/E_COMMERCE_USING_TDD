                ...
                <tr>
                	...
                	%>
						...
						<td>
                           ...
                           <!--  <a href="#editEmployeeModal?=<% model.getU_id(); %> %>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                         -->
...
%>
    ...
    <div class="container" id="product-list">
        <div class="table-wrapper">
	        ...
	        <%--                 <a href="edituser.jsp?userId=<%= model.getU_id() %>"  class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
             --%>
                            <a href="editProduct.jsp?pid=<%=pmodel.getP_id() %>" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
   ...
   <%
    ...
    IDAO mydao3=new DB_Connection();
    ProductModel mypromodel=mydao3.getProductRecordById(pd);
